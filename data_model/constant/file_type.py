...
FILE_BACKGROUND_INFO_INDIRECT_COMMS = 73
...
FILETYPES_BACKGROUND = [FILE_BACKGROUND_INFO, FILE_BACKGROUND_INFO_DIRECT, FILE_BACKGROUND_INFO_INDIRECT_COMMS]
FILETYPES_CHARACTER = [FILE_STUDENT_INFO, FILE_CHARACTER_INFO]
FILETYPES_UI = [FILE_UI_CHILD, FILE_UI_EVENT]
