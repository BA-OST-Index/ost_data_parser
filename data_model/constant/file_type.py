...
FILETYPES_STORY = [FILE_STORY_MAIN, FILE_STORY_SIDE, FILE_STORY_SHORT, FILE_STORY_EVENT,
                   FILE_STORY_BOND, FILE_STORY_OTHER]
FILETYPES_BATTLE = [FILE_BATTLE_MAIN, FILE_BATTLE_EVENT, FILE_BATTLE_ARENA, FILE_BATTLE_TOTAL_ASSAULT,
                    FILE_BATTLE_BOUNTY_HUNT, FILE_BATTLE_SCHOOL_EXCHANGE, FILE_BATTLE_SPECIAL_COMMISSION]
FILETYPES_UI = [FILE_UI_CHILD]
...
FILETYPES_STORY_DIR = [FILE_DIR_MAIN_STORY_ALL, FILE_DIR_MAIN_STORY_CATEGORY, FILE_DIR_MAIN_STORY_VOLUME,
                       FILE_DIR_MAIN_STORY_CHAPTER, FILE_DIR_EVENT_STORY, FILE_DIR_STUDENT_BOND]
FILETYPES_BATTLE_DIR = [FILE_DIR_MAIN_BATTLE_ALL, FILE_DIR_MAIN_BATTLE_CATEGORY, FILE_DIR_MAIN_BATTLE_CHAPTER,
                        FILE_DIR_MAIN_BATTLE_ARENA, FILE_DIR_MAIN_BATTLE_3, FILE_DIR_EVENT_BATTLE]
